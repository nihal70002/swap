...
export default function Hero() {
  return (
    <section className="relative min-h-[85vh] md:min-h-[72vh] flex items-center justify-center overflow-hidden bg-[#F8F9FA]">

      {/* BACKGROUND GIANT TEXT */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full pointer-events-none select-none opacity-[0.04] flex flex-col items-center">
      ...
      {/* HERO CONTENT GRID */}
      <div className="max-w-6xl mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-3 items-center gap-8 md:gap-16">

        {/* LEFT TEXT */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left pr-6 lg:pr-10 md:-translate-y-4 lg:-translate-y-6">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold uppercase leading-none tracking-tight text-slate-900" style={{ fontFamily: "'Syne', sans-serif" }}>
            THINK<br />
...
height: "min(110vw, 470px)",
  ...
  <div style={{
    ...
    marginTop: "auto"
        ...
        {/* RIGHT TEXT */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left pl-6 lg:pl-10 md:-translate-y-4 lg:-translate-y-6">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold uppercase leading-none tracking-tight text-slate-900" style={{ fontFamily: "'Syne', sans-serif" }}>
            Think <br />
